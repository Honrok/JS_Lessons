...
function t5() {
    a5_res = [];
    a5_res = a5.filter(item => typeof (item) == 'number' && item % 2 == 0);
    return a5_res;
}
...
function t6() {
    a6_res = [];
    a6_res = a6.filter(item => typeof (item) == 'number' && item > 14);
    return a6_res;
}
...
function t9() {
    let v = [];
    a9.forEach(elem => v.push(elem.toLowerCase()));
    a9 = v;
    return a9;
}
...
function t14() {
    ...
    a14 = a14.map(elem => elem.toLowerCase());
